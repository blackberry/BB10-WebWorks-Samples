...
var _contacts = {
	...
	insertContact: function (contact) {
		...
		/* Display our Contact details. */
		if (contact.nickname === null || contact.nickname === '') {
			contact.nickname = 'No nickname.';
		}
		div.setAttribute('data-bb-title', contact.nickname);
		div.innerHTML = contact.name.givenName + " " + contact.name.familyName;
	...
	deleteContact: function () {
		...
		if (selected) {
			...
			selectedContact.remove(onSuccess, onError);
		} else {
