    ...
    loadScreen: function(url, id, popping, guid, params, screenRecord) {
        var xhr = new XMLHttpRequest(),
            ...
            _reduce = function(nl, func, start) {
                ...
                Array.prototype.forEach.apply(nl, [
                    function(v) {
...
bb.actionBar = {
    ...
    apply: function(actionBar, screen) {
        ...
        bb.windowListeners.push({
            name: 'contextmenu',
            eventHandler: actionBar.oncontextmenu
        });
        ...
        bb.windowListeners.push({
            ...
            eventHandler: actionBar.reLayoutActionBar
        });
...
bb.menuBar = {
    ...
    createSwipeMenu: function(menuBar, screen) {
        ...
        bb.windowListeners.push({
            name: 'contextmenu',
            eventHandler: bb10Menu.oncontextmenu
        });
        ...
        bb.windowListeners.push({
            name: 'resize',
            eventHandler: bb.menuBar.menu.doOrientationChange
        });
...
bb.tabOverflow = {
    ...
    create: function(screen) {
        ...
        bb.windowListeners.push({
            name: 'contextmenu',
            eventHandler: menu.oncontextmenu
        });
        ...
        bb.windowListeners.push({
            name: 'orientationchange',
            eventHandler: menu.orientationChanged
        });
...
_bb10_contextMenu = {
    ...
    create: function(screen) {
        ...
        bb.documentListeners.push({
            name: 'bbui.contextClosed',
            eventHandler: menu.oncontextmenuclosed
        });
...
_bb10_grid = {
    apply: function(elements) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            bb.windowListeners.push({
                name: 'resize',
                eventHandler: outerElement.orientationChanged
            });
                        ...
                        innerChildNode.touchTimer = function() {
                            if (bb.device.isPlayBook) {
                                ...
                                if (innerChildNode.fingerDown && Math.abs(innerChildNode.touchstartx - curx) < 50) {
                                    ...
                                    innerChildNode.contextMenu.peek({
                                        title: this.title,
                                        description: this.description,
                                        selected: this
                                    });
