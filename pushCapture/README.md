...
6. Open a console, cd to your project directory and install the following plugins
		1. webworks plugin add com.blackberry.invoked
		2. webworks plugin add com.blackberry.push
		3. webworks plugin add com.blackberry.system
		4. webworks plugin add com.blackberry.ui.dialog
		5. webworks plugin add com.blackberry.ui.toast
		6. webworks plugin add com.blackberry.notification
