...
sample.pushcapture.constructor.prototype.deletePush = function(pushId) {
	...
	document.getElementById("img" + sample.pushcapture.selectedPushSeqnum).src = "img/trashhighlight.png";
...
sample.pushcapture.constructor.prototype.deleteCallback = function(selection) {
	...
	document.getElementById("img" + sample.pushcapture.selectedPushSeqnum).src = "img/trash.png";
