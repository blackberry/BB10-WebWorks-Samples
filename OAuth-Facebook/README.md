...
3. **Replace** the default OAuth-Facebook\www folder with the \www folder from **this** project
4. From the command prompt (Windows) or terminal (mac), navigate to the OAuth-Facebook folder
