...
define('effects/SlideEffect',['effects/Effect'], function (Effect) {
    ...
    var SlideEffect = Effect.extend({
        ...
        fromViewTransitionProps:{duration:0.3, easing:'ease-out', delay:0},

        toViewTransitionProps:{duration:0.3, easing:'ease-out', delay:0},

		//this is where I need to modify to allow for stacking
        play:function ($fromView, $toView, callback, context, task) {
...
define('effects/FadeEffect',['effects/Effect'], function (Effect) {
    ...
    var FadeEffect = Effect.extend({
        ...
        fromViewTransitionProps:{duration:0.2, easing:'linear', delay:0},

        toViewTransitionProps:{duration:0.3, easing:'linear', delay:0.2},
